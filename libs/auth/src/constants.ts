...
export const AZURE_CONFIG = Symbol('AZURE_CONFIG');
export const COGNITO_CONFIG = Symbol('COGNITO_CONFIG');
...
export const AZURE_STRATEGY = 'azure-bearer-strategy';
export const COGNITO_STRATEGY = 'cognito-strategy';
